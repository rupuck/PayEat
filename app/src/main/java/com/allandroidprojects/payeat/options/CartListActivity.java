package com.allandroidprojects.payeat.options;
...
import com.allandroidprojects.payeat.done;
...
import static com.allandroidprojects.payeat.fragments.ImageListFragment.STRING_IMAGE_POSITION;
import static com.allandroidprojects.payeat.fragments.ImageListFragment.STRING_IMAGE_URI;
...
//                ((BitmapDrawable) holder.mImageView.getTopLevelDrawable()).getBitmap().recycle();
    ...
    public void bayar(View view){
        ...
        asd.setHitung(0);
        Intent i = new Intent(CartListActivity.this, done.class);
        startActivity(i);
    }
}
